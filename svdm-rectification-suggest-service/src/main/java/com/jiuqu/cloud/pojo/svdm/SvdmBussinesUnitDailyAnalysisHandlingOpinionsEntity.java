...
@Entity
@Table(name = "svdm_bussines_unit_daily_analysis_handling_opinions", schema = "2018svdm", catalog = "")
public class SvdmBussinesUnitDailyAnalysisHandlingOpinionsEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        SvdmBussinesUnitDailyAnalysisHandlingOpinionsEntity that = (SvdmBussinesUnitDailyAnalysisHandlingOpinionsEntity) o;
        return id == that.id &&
