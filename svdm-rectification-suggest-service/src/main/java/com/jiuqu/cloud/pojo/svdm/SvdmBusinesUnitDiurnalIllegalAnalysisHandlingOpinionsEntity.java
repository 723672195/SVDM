...
@Entity
@Table(name = "svdm_busines_unit_diurnal_illegal_analysis_handling_opinions", schema = "2018svdm", catalog = "")
public class SvdmBusinesUnitDiurnalIllegalAnalysisHandlingOpinionsEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        SvdmBusinesUnitDiurnalIllegalAnalysisHandlingOpinionsEntity that = (SvdmBusinesUnitDiurnalIllegalAnalysisHandlingOpinionsEntity) o;
        return id == that.id &&
