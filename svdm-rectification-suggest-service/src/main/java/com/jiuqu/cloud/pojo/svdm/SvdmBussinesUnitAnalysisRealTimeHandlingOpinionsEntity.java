...
@Entity
@Table(name = "svdm_bussines_unit_analysis_real_time_handling_opinions", schema = "svdm", catalog = "")
public class SvdmBussinesUnitAnalysisRealTimeHandlingOpinionsEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        SvdmBussinesUnitAnalysisRealTimeHandlingOpinionsEntity that = (SvdmBussinesUnitAnalysisRealTimeHandlingOpinionsEntity) o;
        return id == that.id &&
