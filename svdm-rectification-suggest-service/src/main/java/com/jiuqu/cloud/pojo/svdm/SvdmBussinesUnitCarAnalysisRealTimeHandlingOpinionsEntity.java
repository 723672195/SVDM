...
@Entity
@Table(name = "svdm_bussines_unit_car_analysis_real_time_handling_opinions", schema = "2018svdm", catalog = "")
public class SvdmBussinesUnitCarAnalysisRealTimeHandlingOpinionsEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        SvdmBussinesUnitCarAnalysisRealTimeHandlingOpinionsEntity that = (SvdmBussinesUnitCarAnalysisRealTimeHandlingOpinionsEntity) o;
        return id == that.id &&
