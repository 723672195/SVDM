...
public class SvdmBusinessUnitEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (unitParentUnit != null ? !unitParentUnit.equals(that.unitParentUnit) : that.unitParentUnit != null)
            return false;
        if (unitTransportScope != null ? !unitTransportScope.equals(that.unitTransportScope) : that.unitTransportScope != null)
            return false;
        if (unitSafeModeSummary != null ? !unitSafeModeSummary.equals(that.unitSafeModeSummary) : that.unitSafeModeSummary != null)
            return false;
        if (isCreateMonitorPlatform != null ? !isCreateMonitorPlatform.equals(that.isCreateMonitorPlatform) : that.isCreateMonitorPlatform != null)
            return false;
        if (isExclusiveParking != null ? !isExclusiveParking.equals(that.isExclusiveParking) : that.isExclusiveParking != null)
            return false;
        if (isExclusiveTrainingVenues != null ? !isExclusiveTrainingVenues.equals(that.isExclusiveTrainingVenues) : that.isExclusiveTrainingVenues != null)
            return false;
        if (jurisdictionUnit != null ? !jurisdictionUnit.equals(that.jurisdictionUnit) : that.jurisdictionUnit != null)
            return false;
        if (jurisdictionPolice != null ? !jurisdictionPolice.equals(that.jurisdictionPolice) : that.jurisdictionPolice != null)
            return false;
        if (jurisdictionStartTime != null ? !jurisdictionStartTime.equals(that.jurisdictionStartTime) : that.jurisdictionStartTime != null)
            return false;
        if (passengerCarNumber != null ? !passengerCarNumber.equals(that.passengerCarNumber) : that.passengerCarNumber != null)
            return false;
        if (busNumber != null ? !busNumber.equals(that.busNumber) : that.busNumber != null) return false;
        if (dangerousCarNumber != null ? !dangerousCarNumber.equals(that.dangerousCarNumber) : that.dangerousCarNumber != null)
            return false;
        if (freightCarNumber != null ? !freightCarNumber.equals(that.freightCarNumber) : that.freightCarNumber != null)
            return false;
        if (othersCarNumber != null ? !othersCarNumber.equals(that.othersCarNumber) : that.othersCarNumber != null)
            return false;
        if (freightCarDriverNumber != null ? !freightCarDriverNumber.equals(that.freightCarDriverNumber) : that.freightCarDriverNumber != null)
            return false;
        if (busDriverNumber != null ? !busDriverNumber.equals(that.busDriverNumber) : that.busDriverNumber != null)
            return false;
        if (dangerousCarDriverNumber != null ? !dangerousCarDriverNumber.equals(that.dangerousCarDriverNumber) : that.dangerousCarDriverNumber != null)
            return false;
        if (passengerCarDriverNumber != null ? !passengerCarDriverNumber.equals(that.passengerCarDriverNumber) : that.passengerCarDriverNumber != null)
            return false;
        if (othersCarDriverNumber != null ? !othersCarDriverNumber.equals(that.othersCarDriverNumber) : that.othersCarDriverNumber != null)
            return false;
        if (transportCarOperation != null ? !transportCarOperation.equals(that.transportCarOperation) : that.transportCarOperation != null)
            return false;
        if (transportSecurityRisks != null ? !transportSecurityRisks.equals(that.transportSecurityRisks) : that.transportSecurityRisks != null)
            return false;
        ...
        if (unitCorporateName != null ? !unitCorporateName.equals(that.unitCorporateName) : that.unitCorporateName != null)
            return false;
        if (unitCorporatePhone != null ? !unitCorporatePhone.equals(that.unitCorporatePhone) : that.unitCorporatePhone != null)
            return false;
        if (unitContactPersonName != null ? !unitContactPersonName.equals(that.unitContactPersonName) : that.unitContactPersonName != null)
            return false;
        if (unitContactPersonPhone != null ? !unitContactPersonPhone.equals(that.unitContactPersonPhone) : that.unitContactPersonPhone != null)
            return false;
