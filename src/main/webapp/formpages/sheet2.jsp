...
//			$("#msg").html(message+carCount+"。");
            ...
            riskTableMsg[3] = "超载行驶";
            riskTableMsg[4] = "违规载人载物";
            riskTableMsg[5] = "违规行驶";
            riskTableMsg[6] = "驾驶人违规行为";
            riskTableMsg[7] = "违规行为";
            riskTableMsg[8] = "高速超速行驶";
            riskTableMsg[9] = "超员行驶";
            riskTableMsg[10] = "超速预警";
            riskTableMsg[11] = "疲劳驾驶预警";
            riskTableMsg[12] = "其他预警";
            riskTableMsg[13] = "超时停车预警";
            riskTableMsg[14] = "行驶路线异常预警";
            riskTableMsg[15] = "驾驶时长异常预警";
            riskTableMsg[16] = "车辆异常预警";
            riskTableMsg[17] = "终端设备故障预警";
            riskTableMsg[18] = "车辆非法行驶预警";
            riskTableMsg[19] = "高速违规行驶";
            riskTableMsg[20] = "路线偏离预警  ";
...
//        }
        ...
        mycarchaozai[2] = "大型货运汽车载物，高度从地面起不准超过4米，宽度不准超过车厢，长度前端不准超出车身，后端不准超出车身2米，超过部分不准触地";
        mycarchaozai[3] = "严禁超载，核载质量在1000公斤以上的小型货运汽车载物，高度从地面起不准超过2.5米，宽度不准超出车厢，前端不准超出车身，后端不准超出车厢1米";
        mycarchaozai[4] = "严禁超载，核载质量不满1000公斤的小型货运汽车，高度从地面起不准超过2米，宽度不准超出车厢，长度前端不准超出车厢，后端不准超出车厢50厘米";
