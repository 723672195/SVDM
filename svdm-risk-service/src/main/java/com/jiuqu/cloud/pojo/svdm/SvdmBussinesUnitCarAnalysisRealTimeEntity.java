...
@Entity
@Table(name = "svdm_bussines_unit_car_analysis_real_time", schema = "svdm", catalog = "")
public class SvdmBussinesUnitCarAnalysisRealTimeEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        SvdmBussinesUnitCarAnalysisRealTimeEntity that = (SvdmBussinesUnitCarAnalysisRealTimeEntity) o;
        return id == that.id &&
