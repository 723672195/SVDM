 ...
 */
@RestController
public class CompanyRealController {
    @Autowired
    private CompanyRealService companyRealService;

    /**
     * 根据公司id查询驾驶人员,车辆,道路,天气,管理信息以及风险信息和RAL
     * @return
     */
    @RequestMapping("/findUnitMessage")
    public List findUnitRAL(@RequestParam("unit_id") Long unitId){
        try {
            List<Map<String,Object>>  bussinessUnits = companyRealService.findUnitAll(unitId);
     ...
     * @return
     */
    @RequestMapping("/findUnitAnalysis")
    public List findUnitAnalysis(@RequestParam("unit_id") Long unitId){
        try {
            List<Map<String,Object>>  bussinessUnits = companyRealService.findUnitAnalysis(unitId);
